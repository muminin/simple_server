...
class Ion_auth_model extends CI_Model
{
	...
	public function get_users_groups($id=FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'].'.'.$this->join['groups'].' as id, '.$this->tables['groups'].'.name, '.$this->tables['groups'].'.description, '.$this->tables['groups'].'.alamat,'.$this->tables['groups'].'.kepala_opd,'.$this->tables['groups'].'.nip,'.$this->tables['groups'].'.kode_pos,'.$this->tables['groups'].'.telepon,'.$this->tables['groups'].'.fax,'.$this->tables['groups'].'.web,'.$this->tables['groups'].'.email')
