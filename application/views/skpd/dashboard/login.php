            ...
            <div class="row flex-grow">
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        ...
                        <h4>Welcome back!</h4>
                        <h6 id="notifikasi" class="font-weight-light">Happy to see you again!</h6>
                        <form id="form_login" class="pt-3">
                            ...
                            <div class="my-3">
                                ...
                                <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" id="login" value="LOGIN">
                            </div>
