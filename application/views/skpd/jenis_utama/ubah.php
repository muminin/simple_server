            ...
            <div class="card">
                <div class="card-body">
                    <form class="cmxform" id="tambah">
                        <input type="hidden" name="id" value="<?php echo $jenis_utama["id"]; ?>">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="nama" class="form-control form-control-sm" type="nama" name="nama" value="<?php echo $jenis_utama["nama_jenis_utama"] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
