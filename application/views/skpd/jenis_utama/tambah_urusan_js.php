<script>
    $(document).ready(function() {
        ...
        $("#tambah_data").click(function() {
            ...
            if ($("#count_data").val() != "") {
                ...
                for (var i = global_count; i < last_count; i++) {
                    ...
                    data_val += "<td><input type='number' name='kode[]' id='kode_" + i + "' class='form-control form-control-sm' placeholder='Kode Urusan'></td>";
        ...
        $("#tambah").submit(function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url("skpd/Jenis_utama/tambah_urusan"); ?>",
                type: "post",
