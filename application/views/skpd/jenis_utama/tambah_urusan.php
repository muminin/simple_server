            ...
            <div class="card">
                <div class="card-body">
                    <form class="cmxform" id="tambah">
                        <input type="hidden" name="id" id="id" value="<?php echo $jenis_utama["id"]; ?>">
                            ...
                            <div class="col-lg-12">
                                <table>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php echo $jenis_utama["tahun"]; ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Utama</td>
                                        <td>:</td>
                                        <td><?php echo $jenis_utama["nama_jenis_utama"]; ?></td>
                                        <td></td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="tab_data" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="row-aksi">Kode Urusan</th>
                                                    <th>Nama Urusan</th>
                                                    <th class="row-aksi">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($urusan as $key => $val) { ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $val["kd_urusan"]; ?></td>
                                                        <td colspan="2"><?php echo $val["nm_urusan"]; ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
