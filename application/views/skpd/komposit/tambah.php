                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="uraian" name="uraian" placeholder="Uraian">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan" rows="3" style="resize: vertical;" placeholder="Keterangan"></textarea>
                                </div>
                            </div>
                            ...
                            <?php if ($group_id != 1) { ?>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="nilai" name="nilai" placeholder="Nilai">
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
