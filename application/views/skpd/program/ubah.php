                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="kode" class="form-control form-control-sm" name="kode" min="0" value="<?php echo $program["kd_program"] ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama" class="form-control form-control-sm" name="nama" value="<?php echo $program["nm_program"] ?>">
                                </div>
                            </div>
                        </div>
