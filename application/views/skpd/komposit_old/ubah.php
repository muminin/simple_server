            ...
            <div class="card">
                <div class="card-body">
                    <form class="cmxform" id="tambah">
                        <input type="hidden" id="id" name="id" value="<?php echo $komposit["id"]; ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="nama" name="nama" placeholder="Nama" value="<?php echo $komposit["nama"]; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label for="data">
                                        ...
                                        <label id="rumus_show">
                                            <?php echo $komposit["rumus_view"]; ?>
                                        </label>
                                        <textarea class="form-control form-control-sm" name="rumus" id="rumus" rows="2" style="display: none;"><?php echo $komposit["rumus"]; ?></textarea>
                                    </label>
                                </div>
                            </div>
                        </div>
