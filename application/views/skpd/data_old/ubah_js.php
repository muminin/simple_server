<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(item) {
                    selected = "";
                    if (item.id == <?php echo $data["id_urusan"]; ?>) {
                        selected = "selected";
                    }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(function(item) {
                            selected = "";
                            if (item.id == <?php echo $data["id_bidang"]; ?>) {
                                selected = "selected";
                            }
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                data.forEach(function(item) {
                                    selected = "";
                                    if (item.id == <?php echo $data["id_program"]; ?>) {
                                        selected = "selected";
                                    }
        ...
        $("#tambah").submit(function(event) {
            ...
            var check = ["jenis_utama", "urusan", "bidang", "program", "uraian"];
