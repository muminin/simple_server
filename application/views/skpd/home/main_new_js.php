<script>
    $(document).ready(function() {
        ...
        $("#tab_landing").on("click", ".select-jenis", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var result = "<tbody id='data_body'>";
                    data.forEach(function(item) {
                        result += "<tr class='select-urusan' data-id='" + item.id + "' data-jenis='" + item.jenis_id + "' data-name='" + item.nm_urusan + "' style='cursor: pointer;'>";
                        result += "<td>";
        ...
        $("#tab_landing").on("click", ".select-urusan", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var result = "<tbody id='data_body'>";
                    data.forEach(function(item) {
                        result += "<tr class='select-bidang' data-id='" + item.id + "' data-urusan='" + item.urusan_id + "' data-name='" + item.nm_bidang + "' style='cursor: pointer;'>";
                        result += "<td>";
        ...
        $("#tab_landing").on("click", ".select-bidang", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var result = "<tbody id='data_body'>";
                    data.forEach(function(item) {
                        result += "<tr class='select-program' data-id='" + item.id + "' data-bidang='" + item.bidang_id + "' data-name='" + item.nm_program + "' style='cursor: pointer;'>";
                        result += "<td>";
        ...
        $("#tab_landing").on("click", ".select-program", function() {
            ...
            removeActiveBread("kegiatan");

            $.ajax({
                url: "<?php echo base_url("skpd/Home/get_kegiatan") ?>",
                type: "post",
                data: {
                    program: id,
                },
                ...
                success: function(data) {
                    ...
                    var result = "<tbody id='data_body'>";
                    data.forEach(function(item) {
                        result += "<tr class='select-kegiatan' data-id='" + item.id + "' data-program='" + item.program_id + "' data-name='" + item.nama + "' style='cursor: pointer;'>";
                        result += "<td>";
                        result += item.nama;
                        result += "</td>";
                        result += "</tr>";
        ...
        // GET DATA
        $("#tab_landing").on("click", ".select-kegiatan", function() {
            var id = $(this).attr("data-id");
            var bidang = $(this).attr("data-bidang");
            var name = $(this).attr("data-name");
            $("#l_program").attr("data-id", bidang);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data != "[]") {
                        ...
                        result += "<th class='text-center' style='width: 100px;'>Tanggal Perubahan</th>";
                        result += "</tr>";
                        for (var i = 1; i <= level; i++) {
                            $.each(data, function(key, item) {
                                $.each(item, function(key2, item2) {
                                    if (item2.level == i && item2.level == 1) {
                                        result += "<tr class='select-data' id='row_" + item2.id + "' data-level='" + item2.level + "' data-id='" + item2.id + "' data-program='" + item2.program_id + "' data-name='" + item2.uraian + "' style='cursor: pointer;'>";
                                        ...
                                        result += "<td class='strong'><center>" + item2.tanggal_update + "</center></td>";
                                        result += "</tr>";
                                    }
                                });
                            });
                            ...
                            $.each(data, function(key, item) {
                                ...
                                $.each(item, function(key2, item2) {
                                    if (item2.level == i && item2.level != 1) {
                                        ...
                                        var tr_child = "";
                                        tr_child += "<tr class='select-data' id='row_" + item2.id + "' data-level='" + item2.level + "' data-id='" + item2.id + "' data-program='" + item2.program_id + "' data-name='" + item2.uraian + "' style='cursor: pointer;'>";
                                        ...
                                        tr_child += "<td><center>" + item2.tanggal_update + "</center></td>";
                                        tr_child += "</tr>";
            ...
            if (!$(this).hasClass("active")) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var result = "<tbody id='data_body'>";
                        data.forEach(function(item) {
                            result += "<tr class='select-urusan' data-id='" + item.id + "' data-urusan='" + item.urusan_id + "' data-name='" + item.nm_urusan + "' style='cursor: pointer;'>";
                            result += "<td>";
                            result += item.nm_urusan;
                            result += "</td>";
                            result += "</tr>";
