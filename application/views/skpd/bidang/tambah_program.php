                            ...
                            <div class="col-lg-12">
                                <table>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php echo $bidang["jenis_tahun"]; ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Utama</td>
                                        <td>:</td>
                                        <td><?php echo $bidang["jenis_nama"]; ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Urusan</td>
                                        <td>:</td>
                                        <td><?php echo $bidang["urusan_kode"] . ". " . $bidang["urusan_nama"]; ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Bidang</td>
                                        <td>:</td>
                                        <td><?php echo $bidang["kd_bidang"] . ". " . $bidang["nm_bidang"]; ?></td>
                                        <td></td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="tab_data" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="row-aksi">Kode Program</th>
                                                    <th>Nama Program</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($program as $key => $val) { ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $val["kd_program"]; ?></td>
                                                        <td colspan="2"><?php echo $val["nm_program"]; ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
