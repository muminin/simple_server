            ...
            <div class="card">
                <div class="card-body">
                    <form class="cmxform" id="tambah">
                        <input type="hidden" name="id" id="id" value="<?php echo $bidang["id"]; ?>">
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kode">
                                        Kode Bidang <span class="text-youtube">* <small id="err_kode"></small></span>
                                    </label>
                                    <input type="number" id="kode" class="form-control form-control-sm" name="kode" min="0" value="<?php echo $bidang["kd_bidang"]; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama">
                                        Nama Bidang <span class="text-youtube">* <small id="err_nama"></small></span>
                                    </label>
                                    <input type="text" id="nama" class="form-control form-control-sm" name="nama" value="<?php echo $bidang["nm_bidang"]; ?>">
                                </div>
                            </div>
                        </div>
