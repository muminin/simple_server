                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="tab_urusan" class="table table-bordered">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($urusan as $key => $val) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $val["kd_urusan"]; ?></td>
                                                <td><?php echo $val["nm_urusan"]; ?></td>
                                                <td>
                                                    <div class="text-center">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-sm add-bidang" data-id="<?php echo $val["id"]; ?>"><i class="ti-plus"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php
