<script>
    $(document).ready(function() {
        ...
        $(".edit").click(function() {
            ...
            window.location.href = "<?php echo base_url("skpd/Urusan/ubah?id="); ?>" + id;
        });

        $(".delete").click(function() {
            var id = $(this).attr("data-id");
            $.ajax({
                url: "<?php echo base_url("skpd/Urusan/hapus?id=") ?>" + id,
                type: "get",
                ...
                success: function(data) {
                    if (data == 1) {
                        showSuccessToast("Data Urusan berhasil dihapus.",
        ...
        $(".add-bidang").click(function() {
            var id = $(this).attr("data-id");
            window.location.href = "<?php echo base_url("skpd/Urusan/tambah_bidang?id="); ?>" + id;
        });

        // $("#btn_filter").click(function() {
        //     var tahun = $("#tahun").val();
        //     var url = "tahun=" + tahun;
        //     window.location.href = "<?php echo base_url("skpd/Urusan?"); ?>" + url;
        // });
    });
</script>